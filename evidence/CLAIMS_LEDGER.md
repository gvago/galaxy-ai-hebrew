...
| C19 | Samsung Israel customer service replied in writing (2026-09-09, signed "יובל, סמסונג ישראל") to a Hebrew feature request. Quotable, verbatim: "צוותי הפיתוח של Samsung פועלים במלוא המרץ על מנת להרחיב את התמיכה השפתית של המערכת, ובפרט להוסיף תמיכה מלאה בעברית. עם זאת, נכון לעכשיו, אין לנו אפשרות לספק צפי מדויק למועד ההשקה של תמיכה זו." Also acknowledges that "חלק מתכונות ... Galaxy AI ... אינן זמינות בשפה העברית בשלב זה" and refers to the Members community for updates. No case number, no named owner, no date. **Response level R1+**: substantive text, still generic. | Email to Guy | `private/samsung-correspondence/2026-09-09-email-reply-yuval.md` | 2026-09-09 | Guy (recipient) |
| C20 | Samsung Israel customer service, second written reply (2026-09-10): (a) case numbers are never shared, by policy: "מספרי הפניות שמורות אצלינו בממשק ומדובר בממשק פרטי ולכן לא נוכל לשתף אותך במספר פנייה"; the sender's email address is the lookup key. (b) The channel for feature demand is the Members app error report to the engineering team, explicitly "כדי להגדיל את הביקוש להוספת התמיכה בשפה העברית". (c) Decision rule: suggestions go to the global development team "להמשך שיקול בהתאם לביקוש והמשאבים הזמינים". (d) When Hebrew is near release there will be posts and teasers in the Members community. **R1+** again: informative, no owner, no date, no case reference. | Email to Guy | `private/samsung-correspondence/2026-09-10-email-reply-2-yuval.md` | 2026-09-10 | Guy (recipient) |
| C21 | ynet (Rafael Kahan, Galaxy S26 Ultra review, 2026-03-17) already reported the gap: "למרות ההבטחות החוזרות ונשנות, התמיכה בעברית ב-Galaxy AI נותרה מוגבלת... התמלול של שיחות או התרגום בלייב (עדיין) לא עובד כלל בעברית." Independent, mainstream, six months before the campaign. Useful as third-party corroboration and as the natural journalist to brief. | ynet | S-ynet-s26u | 2026-09-15 | |
...
| "Samsung is deliberately withholding Hebrew" | No evidence; intent claims are unsourceable. Contradicted by C19 (Samsung IL says teams are working on it). |
| The CS agent's name, or the CS emails verbatim, in press or partner material | Frontline agent, private channel. Paraphrase and attribute to "Samsung Israel customer service, [date]". Verbatim only on our own site, where it already is, and unnamed there too (D30). |
| "Samsung promised Hebrew" / "Samsung is about to release Hebrew" | C19 is a customer-service reply with no date and no product-team attribution. Say exactly what it says: Samsung Israel wrote that development teams are working on full Hebrew support and cannot give a timeline. |
