...
- **D18** (2026-09-09) Do NOT post the campaign on the Samsung Members community website (r2.community.samsung.com/il). Its rules ban "spam, advertising, solicitation or lobbying (or links to them)"; a survey link is lobbying by their definition and risks flagging Guy before the dossier lands. Feedback with a reference number goes through the Members **app** Support tab. Reserved use of the website: one factual question ("is Hebrew planned for Live Translate?") in Week 7, to get an on-record staff answer (Lior, community manager; Lina_V, moderator).
- **D19** (2026-09-09) Device evidence captured over adb on Guy's S24 Ultra (38 screenshots, `media/raw/2026-09-09-s24u/`, gitignored): Members flow (C18), Language packs (C16), Live Translate picker (C17). Interpreter and Live Translate: no Hebrew, confirmed on device, matching the website matrix.
- **D20** (2026-09-09) "Documented Samsung submission" KPI redefined: neither IL route issues a case number, so the unit is a screenshot of the Members History row ("Received" + HE-GALAXY-AI-2026 subject) or the email auto-ack. Survey question about case numbers to be reworded accordingly.
- **D21** (2026-09-09) Members request text is English by design: adb text input cannot carry Hebrew reliably, and Samsung's engineering queue is read in English. Hebrew stays for the FB post, site and email.
- **D22** (2026-09-09) Samsung IL email reply received (C19). Scored **R1+**, not R2: substantive and on-topic, but no case number, no owner, no date. It is the campaign's first Samsung-sourced quote and changes the public framing: the ask is no longer "acknowledge the gap" (done) but "name an owner and a date". Reply on the same thread asking for exactly those two things plus a case number. Publish the quote only as customer-service correspondence, never as a product commitment.
- **D23** (2026-09-09) Second Facebook group post (reply on the launch post) published by Guy: count 4, Samsung IL quote (C19), both verified routes, guide link. Site "After you send" now quotes C19 and drops the case-number ask (follows D20). Survey Q on case number still to reword (needs live-form edit approval).
